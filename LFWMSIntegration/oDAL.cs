...
namespace LFWMSIntegration
{
    public class oDAL
    {
        ...
        /*
        public static void UpdatePartCheckBox15(string PartNum, string ConnectionString)
        {
            //string ConnectionString = ConfigurationManager.ConnectionStrings["Lucky10Prod"].ConnectionString;
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                using (SqlCommand sqlCmd = new SqlCommand("Update Part Set CheckBox15=1 Where CheckBox15=0 and PartNum=@PartNum", con))
                {
                    con.Open();
                    //SqlCommand cmd = new SqlCommand(sqlCmd, con);                    
        ...
        */
        ...
        /*
        public static void UpdatePartCheckBox14(string PartNum, string ConnectionString)
        {
            //string ConnectionString = ConfigurationManager.ConnectionStrings["Lucky10Prod"].ConnectionString;
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                using (SqlCommand sqlCmd = new SqlCommand("Update Part Set CheckBox14=1 Where CheckBox14=0 and PartNum=@PartNum", con))
                {
                    con.Open();
                    //SqlCommand cmd = new SqlCommand(sqlCmd, con);                    
                    sqlCmd.Parameters.AddWithValue("@PartNum", PartNum);
        ...
        */
        ...
        public static int GetRows(string ConnectionString, string storeProcName)
        {
            int rowCount = 0;
            //string ConnectionString = ConfigurationManager.ConnectionStrings["Lucky10Prod"].ConnectionString;
            using (SqlConnection con = new SqlConnection(ConnectionString))
